...
export const useRegisterError = (res, setRegisterOk, setRes) => {
  ...
  if (res?.status == 200) {
    /**
     * ----------------PUENTE PARA CUANDO TENEMOS PROBLEMAS DE ASINCRONIA------------------
     * para utilizar el puente cogemos la respuesta la seteamos en el localStorage
     * y luego el puente la utilizara y la borrará del localStorage
     */
  ...
  if (
    ...
    Swal.fire({
      icon: "error",
      title: "Oops...",
      text: "Register ok, error to send code ❎",
      showConfirmButton: false,
      timer: 1500,
    });
    setRes({});
